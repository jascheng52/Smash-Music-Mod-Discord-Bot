...
temp_dir = base_path / "nus3audio_converter"/ "tmp"
input_dir = current_dir / "bot_files" /"compressed_audio"
sox_exe = base_path / "nus3audio_converter"/ "tools" / "sox" / "sox.exe"
temp_wav = temp_dir / "tmp.wav"
vgmstram_test_exe = base_path / "nus3audio_converter"/ "tools" / "vgmstream" / "test.exe"
vgaudio_exe = base_path / "nus3audio_converter"/ "tools" / "VGAudioCli.exe"
lopus = base_path / "nus3audio_converter"/ "tmp" / "tmp.lopus"
nus3audio = base_path / "nus3audio_converter"/ "tools" / "nus3audio.exe"
output_dir = current_dir/ "bot_files" / "smash_audio"
